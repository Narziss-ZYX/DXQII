...
{	
  ...
  SSD1306_WriteByte(0xA0,OLED_CMD); //--set segment re-map 0 to 127 //×óÓÒ¾µÏñ
  SSD1306_WriteByte(0xC0,OLED_CMD); //--set segment re-map 0 to 127 //ÉÏÏÂ¾µÏñ
...
void SSD1306_UpdateScreen(void)
{
	...
	for(m=0;m<8;m++)
	{
		...
		SSD1306_WriteByte(0X01,OLED_CMD);
